...
test_passphrases = '''nyot babgr babgr kqtu kqtu kzshonp ylyk psqk
...
test_passphrase = test_passphrases.split('\n')
valid = 0
for passphrase in test_passphrase:
    print(Counter(passphrase.split(' ')).values())
    if all(x==1 for x in Counter(passphrase.split(' ')).values()):
        valid += 1
